...
open class DatePickerDialog: UIView {
    ...
    open func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel",  datePickerMode: UIDatePickerMode = .dateAndTime, callback: @escaping DatePickerCallback) {
        ...
        datePicker.date = self.defaultDate!
